/**
 * Shared Tailwind preset for NitroBlog AI.
 *
 * Includes the engine's component AND page sources in `content` so consumer
 * sites automatically pick up utility classes used inside `@nitroblog/core`
...
export default {
  content: [
    "./node_modules/@nitroblog/core/src/components/**/*.{astro,html,js,ts,jsx,tsx,md,mdx}",
    "./node_modules/@nitroblog/core/src/pages/**/*.{astro,html,js,ts,jsx,tsx,md,mdx}",
  ],
  theme: {
    extend: {
      colors: {
