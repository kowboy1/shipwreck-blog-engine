...
How to safely upgrade `@nitroblog/core` and `@nitroblog/theme-default` in a site that has the blog integrated.
...
{
  "dependencies": {
    "@nitroblog/core": "git+ssh://git@github.com:YOUR_ORG/nitroblog-ai.git#v0.1.3&workspace=@nitroblog/core"
  }
}
```
